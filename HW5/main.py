...
axes[0, 0].set_title('Temperature at UWRL Site')
...
axes[0, 1].set_title('Temperature at Tony Grove Site')
...
axes[1, 0].set_title("Monthly Resample at UWRL Site")
...
axes[1, 1].set_title("Monthly Resample at Tony Grove Site")
